...
INSERT INTO `questions` VALUES (1,1,'Need help with centering elements for website.','I need help with centering some of the elements of my website','Hey guys, I need help with centring a couple of elements such as the header text so that they are in the middle of the page. ',NULL,'2021-04-05 23:15:35','CSS','CSS Styling'),(2,2,'What are the commands used for commiting in GitHub?','I need help with commiting in GitHub as I have forgotten the commands use.','I need help with commiting in GitHub as I have forgotten the commands use for it. I need to know how to add files and commit them too.',NULL,'2021-04-08 14:47:47','GitHub','GitHub Commits'),(38,3,'What are the best websites to use for finding colours in HTML?','I am currently doing a Web Development module this semester and need help with finding HTML colour codes. I need suggestions of which ones are the best to use.','# Hello, everyone!\n### I would like to use _HTML colour codes_ for my website project that I am doing in my web development module, however I am unsure of which is the best website to use. Do you have any suggestions of some are that are good?\n\n#### Note: I prefer to use hex code over rgb',NULL,'2021-04-29 12:15:23','CSS','CSS Styling');
...
-- Dump completed on 2021-04-30  9:13:22
